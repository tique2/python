...
class PanelProductos:
    def __init__(self, root):
        ...
        self.titulo = tk.Label(self.panel_secundario, text="Productos", bg="blue", fg="white", font=("Helvetica", 16))
    ...
    def crear_formulario(self, titulo, comando_guardar):
        ...
        panel.place(relx=0.25, rely=0.3, relwidth=0.5, relheight=0.39)
